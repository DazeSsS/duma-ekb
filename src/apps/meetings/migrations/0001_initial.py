    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('solution', models.CharField(choices=[('agree', 'Согласны'), ('put_off', 'Отложить'), ('refuse', 'Отказать'), ('take_note', 'Принять к сведению')], max_length=16, verbose_name='Решение')),
                ...
                ('tags', models.ManyToManyField(to='meetings.tag', verbose_name='Ключевые слова')),
            ],
            options={
                'verbose_name': 'вопрос',
